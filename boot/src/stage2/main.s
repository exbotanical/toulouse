...
.data
INIT_REAL_MODE_STAGE2_MSG:
  .asciz  "Stage 2 bootloader loaded in 16-bit real mode"
ATTEMPT_A20_VIA_BIOS_MSG:
  .asciz  "Attempting to enable the A20 line via the BIOS"
READ_MMAP_MSG:
  .asciz  "Reading in memory map from BIOS"
INIT_PROT_MODE_MSG:
  .asciz  "Stage 2 bootloader loaded in 32-bit protected mode"
A20_NOT_ENABLED_BIOS_MSG:
  .asciz  "The A20 line could not be enabled via the BIOS. Attempting enablement via keyboard controller..."
A20_NOT_ENABLED_KEYCTRL_MSG:
  .asciz  "The A20 line could not be enabled via the keyboard controller. Attempting enablement via fast A20..."
A20_NOT_ENABLED_FAST_MSG:
  .asciz  "The A20 line could not be enabled via the Fast A20. Non-recoverable exception. Halting..."
A20_ENABLED_MSG:
  .asciz  "The A20 line has been enabled."
