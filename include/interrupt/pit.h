...
/**
 * Sets up the PIT to generate periodic interrupts at the given frequency `hz`.
 * We can use these interrupts for things like keeping system time, delays/timers, and
 * multi-tasking.
 *
 * @param hz
 */
void pit_init(unsigned short int hz);

#endif /* INTERRUPT_PIT_H */
