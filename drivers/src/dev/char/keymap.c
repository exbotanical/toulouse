...
diacritic_t grave_table[NUM_DIACR] = {
	{ 'A', '\300' },
	{ 'E', '\310' },
	{ 'I', '\314' },
	{ 'O', '\322' },
...
diacritic_t acute_table[NUM_DIACR] = {
	{ 'A', '\301' },
	{ 'E', '\311' },
	{ 'I', '\315' },
	{ 'O', '\323' },
...
diacritic_t circm_table[NUM_DIACR] = {
	{ 'A', '\302' },
	{ 'E', '\312' },
	{ 'I', '\316' },
	{ 'O', '\324' },
...
// Diaeresis (umlaut)
diacritic_t diere_table[NUM_DIACR] = {
  {'A', '\304'},
  {'E', '\313'},
  {'I', '\317'},
  {'O', '\326'},
